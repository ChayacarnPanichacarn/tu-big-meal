...
app.get('/login', async (req,res) => {
    ...
    try{
        ...
        res.cookie('authToken', token, {
            ...
            sameSite: 'Strict', //Not allow cross-origin cookies
...
//******have to be at the end of code*********************** */
//Catch-all route to serve index.html for React Router (catches all requests that don't match any earlier routes.)
app.get('*', (req,res) => {
